...
const Review = () => {
  return (
    <div className='w-full mt-12 mx-auto bg-white from-green-100 to-green-50 px-6 py-16 text-center review'>
      <div className='relative m-auto max-w-xl'>
        ...
        <a href='#' target='_blank'>
          <h2 className='text-4xl text-center lg:text-5xl font-extrabold text-gray-700 mb-6 md:!leading-[55px]'>
            An{' '}
        ...
        <p className='mt-4 font-dm-sans text-desktop-paragraph text-slate-body  text-gray-700'>
      ...
      <div className='mt-6 flex flex-col items-center justify-center space-y-3'>
        <a href='#' target='_blank'>
          <img src='./review.svg' width='250' height='54' alt='' />
        </a>
      </div>
    </div>
  )
